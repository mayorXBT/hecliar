 ...
 * is unbiased. Eight symbols is about 40 bits — thin against an offline
 * attack, but a guess has to be spent as an on-chain lookup against a room
 * that expires, and only ever wins the right to sit at one table.
 */
