...
function GadgetVisual() {
  return <div className="marketing-gadget-demo"><div><span>Scanner</span><b>Read one die</b></div><div><span>Reroll</span><b>Change your hand</b></div><div><span>Wildcard</span><b>Change the count</b></div><p>One assigned tool changes the next read, not the rules.</p></div>;
}
...
export function LandingPage() {
  return (
    <main className="marketing-page">
      ...
      <FeatureShowcase id="gadgets" eyebrow="Change the read" title="One secret tool creates a new angle." copy="When the table enables gadgets, each player receives exactly one. Scanner, Reroll, and Wildcard effects alter a decision without revealing a full hand." visual={<GadgetVisual />} reverse tone="tint" />
